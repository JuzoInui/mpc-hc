...
constexpr COLORREF kOuterStrokeColor = RGB(205, 207, 210);
constexpr COLORREF kInnerStrokeColor = RGB(50, 53, 58);
constexpr COLORREF kButtonFaceColor = RGB(103, 106, 111);
constexpr COLORREF kButtonHighlightColor = RGB(184, 186, 190);
}
...
void CTabletFrameWnd::UpdateMetrics()
{
    ...
    m_bezel = Scale(16);
    m_hardwareHeight = Scale(8);
    m_cornerRadius = Scale(28);
